<template>
    <div class="md:block hidden w-1/3 h-full border-l border-red-50 py-2 px-6 overflow-y-scroll relative">
        ...
        <div class="w-full rounded-lg bg-lightest my-4">
            ...
            <button v-for="(user, id) in users" class="w-full flex hover:bg-lighter p-3 border-t border-lighter" :key="id">
                ...
                <div class="hidden lg:block ml-4">
                    <p v-if="user.firstname === null" class="text-sm font-bold leading-tight"> {{ user.username }} </p>
