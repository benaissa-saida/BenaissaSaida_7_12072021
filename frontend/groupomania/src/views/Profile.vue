      ...
      <div class="container">
          ...
          <div>
            <div class="mt-3 flex items-center justify-around" v-if="mode === 'userProfile'">
              <button @click="deleteProfileUser(user)" class="h-10 px-4 text-white font-semibold bg-red-600 hover:bg-red-400 focus:outline-none rounded-full">
                Supprimer
              </button>
              <button @click="switchToModifProfile()" class="h-10 px-4 text-white font-semibold bg-red-600 hover:bg-red-400 focus:outline-none rounded-full">
                Modifier
              </button>
            </div>
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="mt-1 flex items-center">
                      ...
                      <button @click="$refs.image.click()" type="button" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-red-500 hover:text-white focus:outline-none  ">
                        Changer
                      </button>
                  ...
                  <div class="px-4 py-3  text-right sm:px-6">
                    <button @click="submit()" class="h-10 px-4 text-white font-semibold bg-red-600 hover:bg-red-400 focus:outline-none rounded-full">
